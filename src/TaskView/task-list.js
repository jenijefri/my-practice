          ...
          <tbody>
            {tasks.map((task, index) => (
              <tr key={index} style={{ border: '1px solid #ccc' }}>
                ...
                <td style={{ border: '2px solid black', padding: '8px' }}><span style={{ backgroundColor: task.taskStatusColor, padding: '2px 4px', borderRadius: '4px', color: '#fff' }}>{task.assignTask}</span></td>
